https://defect-prediction-krbnjrtudvbqttbf5jwbpp.streamlit.app/

![결과 탭](day08/lab25_analysis_app/captures/fig3_compare.png)

기준 모델과 내 모델의 정확도·정밀도·재현율을 나란히 견줘, 설비 고장을 얼마나 잘 판단하는지 보여주는 화면입니다.
